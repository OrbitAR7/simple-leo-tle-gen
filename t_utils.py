...
def create_constellation_plots(constellation_data):
    ...
    # Plot 2: Ground Track Pattern with Earth Map using Cartopy
    ax2 = plt.subplot(2, 2, 2, projection=ccrs.PlateCarree())
    ax2.set_global()
    ax2.coastlines(resolution='110m', color='black', linewidth=0.5)
    ax2.add_feature(cfeature.LAND, facecolor='#90EE90', edgecolor='black', alpha=0.8)
    ax2.add_feature(cfeature.OCEAN, facecolor='#87CEEB', alpha=0.8)
    ax2.add_feature(cfeature.BORDERS, linestyle=':', edgecolor='gray', alpha=0.5)
    ...
    scatter2 = ax2.scatter(lons, lats, c=plane_colors, cmap='Set1', 
                          alpha=1.0, s=60, edgecolors='black', linewidth=1.5,
